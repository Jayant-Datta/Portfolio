...
const Projects = () => {
  const projects = [
    ...
    },
    {
      ...
      liveLink: null, // No live link as requested
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 border-t border-l border-gray-200 w-full bg-white">
        ...
        {projects.map((project) => (
          ...
          >
            ...
            {/* Action Buttons */}
            <div className="flex items-center gap-3 font-mono text-[10px] font-bold tracking-widest mt-auto">
              {/* Live Demo Button (Only renders if liveLink exists) */}
              {project.liveLink && (
                <a 
