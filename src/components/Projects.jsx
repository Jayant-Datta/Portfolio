...
const Projects = () => {
  const projects = [
    ...
    },
    {
      ...
      // If using Option A (public folder), set this to: '/cinematica.apk'
      // If using Option B (Google Drive), paste your shared link here:
      downloadLink: 'https://drive.google.com/file/d/1pdIIfWnK2yoRHQ24qJS709rGm35jdG6B/view' 
    },
    {
      id: '04',
    ...
    {
      id: '05',
      title: 'RESEARCH — MACHINE LEARNING & SYSTEMS',
      description: 'Published academic research focusing on modern computing paradigms. Explored architectural methodologies, system optimizations, and implemented data-driven solutions evaluated against industry-standard benchmarks.',
      tools: ['RESEARCH', 'ACADEMIC', 'ANALYSIS', 'DATA'],
        ...
        {projects.map((project) => (
          ...
          >
            ...
            <div className="flex flex-wrap items-center gap-3 font-mono text-[10px] font-bold tracking-widest mt-auto">
              ...
              {/* Dynamic Native Mobile App Download Button */}
              {project.downloadLink && (
                <a 
                  href={project.downloadLink}
                  download="Cinematica.apk"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="border border-gray-300 px-5 py-3 text-black uppercase transition-colors duration-200 hover:bg-[#ff3b30] hover:text-white hover:border-[#4cd964] flex items-center gap-2 bg-white"
                >
